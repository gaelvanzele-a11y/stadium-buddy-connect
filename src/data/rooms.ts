...
export const rooms: Room[] = [
  ...
  },
  {
    ...
    pricePerHour: 18,
    image: roomLogeImg,
    featureKeys: ["Wi-Fi", "TV", "Coffee"],
    description_en: "Cozy VIP lounge with terrace view, ideal for intimate gatherings.",
    description_nl: "Gezellige VIP-lounge met terrasuitzicht, ideaal voor kleine bijeenkomsten.",
  },
  {
    id: "press-room",
    name: "Persruimte A",
